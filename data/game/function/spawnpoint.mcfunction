...
execute if entity @s[x=0.5,y=92,z=63.5,distance=..1] run spawnpoint @s 0 92 63 0
execute if entity @s[x=0.5,y=95,z=76.5,distance=..1] run spawnpoint @s 0 95 76 0
execute if entity @s[x=0.5,y=95,z=84.5,distance=..1] run spawnpoint @s 0 95 84 0
execute if entity @s[x=0.5,y=95,z=99.5,distance=..1] run spawnpoint @s 0 95 99 0
execute if entity @s[x=0.5,y=100,z=96.5,distance=..1] run spawnpoint @s 0 100 96 0
execute if entity @s[x=0.5,y=102,z=87.5,distance=..1] run spawnpoint @s 0 102 87 0
execute if entity @s[x=0.5,y=105,z=67.5,distance=..1] run spawnpoint @s 0 105 67 0
execute if entity @s[x=0.5,y=119,z=60.5,distance=..1] run spawnpoint @s 0 119 60 0
execute if entity @s[x=0.5,y=125,z=48.5,distance=..1] run spawnpoint @s 0 125 48 0
