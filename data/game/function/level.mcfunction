# 從第二個開始
execute if entity @s[x=0.5,y=92,z=2.5,distance=..1] run scoreboard players set @s level 2
execute if entity @s[x=0.5,y=92,z=8.5,distance=..1] run scoreboard players set @s level 3
execute if entity @s[x=0.5,y=92,z=18.5,distance=..1] run scoreboard players set @s level 4
...
execute if entity @s[x=-1.5,y=130,z=17.5,distance=..1] run scoreboard players set @s level 18
execute if entity @s[x=-8.5,y=132,z=8.5,distance=..1] run scoreboard players set @s level 19
execute if entity @s[x=-27.5,y=132,z=8.5,distance=..1] run scoreboard players set @s level 20
# 21關雙紀錄
execute if entity @s[x=-27.5,y=169,z=76.5,distance=..1] run scoreboard players set @s level 21
...
execute if entity @s[x=-20.5,y=179,z=97.5,distance=..1] run scoreboard players set @s level 23
...
execute if entity @s[x=-3.5,y=319,z=6.5,distance=..1] run scoreboard players set @s level 25
execute if entity @s[x=-23.5,y=-8,z=-32.5,distance=..1] run scoreboard players set @s level 26
execute if entity @s[x=-21.5,y=-8,z=-32.5,distance=..1,team=challenge] run clear @s wind_charge
execute if entity @s[x=-21.5,y=-8,z=-32.5,distance=..1,team=challenge] run give @s wind_charge 64
execute if entity @s[x=-21.5,y=-8,z=-32.5,distance=..1,team=generally] run effect give @s minecraft:levitation 25 2
execute if entity @s[x=-19.5,y=56,z=-33.5,distance=..1] run scoreboard players set @s level 27
execute if entity @s[x=-19.5,y=56,z=-33.5,distance=..1,team=challenge] run clear @s wind_charge
