...
execute as @a[scores={play=3}] run tellraw @s ["",{"text":"此地圖版本為:","color":"green"},{"text":"正式版","bold":true,"color":"aqua"},{"score":{"name":"version","objective":"version"},"bold":true,"color":"aqua"},{"text":".0","bold":true,"color":"aqua"}]
